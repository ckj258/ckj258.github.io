...
# 技能概述
1. 两年C++开发经验，掌握lua，java，javascript   
2. 熟练掌握cocos2d的引擎及底层框架和设计思想  
3. 熟练掌握数据结构，良好的编码风格，惯用设计模式  
4. 具有各种类别游戏独立开发经验，如跑酷，棋牌，射击，消除等  
5. 具有服务端项目开发经验（node.js+pomelo），掌握MySQL redis的使用  
6. 10+个独立项目经验  
